...
function getMouseButton(eventObject) {
    ...
    if(eventObject.toString && eventObject.toString().indexOf('MouseEvent') != -1) {
        ...
        switch(eventObject.button) {
            case 0: buttons.left = true; console.log('click key_left'); break;
            case 1: buttons.middle = true; console.log('click key_middle'); break;
            case 2: buttons.right = true; console.log('click key_right'); break;
            default: break;
        }
    } else if(eventObject.button) {
        // MSIE method
        switch(eventObject.button) {
            case 1: buttons.left = true;console.log('click key_left'); break;
            case 2: buttons.right = true;console.log('click key_right'); break;
            case 3:
                buttons.left = true;
                buttons.right = true;
                console.log('click left and right  key');
            break;
            case 4: buttons.middle = true; console.log('click key_middle'); break;
            case 5:
                buttons.left = true;
                buttons.middle = true;
                console.log('click left and middle  key');
            break;
            case 6:
                buttons.middle = true;
                buttons.right = true;
                console.log('click right and middle  key');
            break;
            case 7:
                buttons.left = true;
                buttons.middle = true;
                buttons.right = true;
                console.log('click on the left and middle and right  key');
            break;
            default: console.log('none click'); break;
        }
    } else {
        return false;
    }
